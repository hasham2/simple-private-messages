...
This fork utilizes polymorphic association between message and other models.

Sender and recipient can be instances of diffrent classes.
...
Go to your app folder and run : 
  rails plugin install git://github.com/hasham2/simple-private-messages.git
